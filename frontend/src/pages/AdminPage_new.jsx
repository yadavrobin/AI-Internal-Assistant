...
const AdminPage = () => {
  ...
  const loadQueries = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setQueriesTotal(mockQueries.length);
  ...
  const handleAddKnowledge = async () => {
    ...
    try {
      ...
      setKnowledgeEntries(prev => [...prev, newKnowledgeEntry]);
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 3 }}>
      ...
      <Paper sx={{ width: '100%', backgroundColor: '#262626' }}>
        <Tabs
          value={tabValue}
            ...
            {knowledgeLoading ? (
              ...
              <Box>
                ...
                {knowledgeEntries.map((entry) => (
                  <Card key={entry.id} sx={{ mb: 2, backgroundColor: '#1a1a1a' }}>
                    <CardContent>
